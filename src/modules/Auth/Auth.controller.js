...
export const SignIn = async(req, res, next)=>{
    ...
    const token = jwt.sign({id:user._id, role: user.role, status: user.status}, process.env.LOGINSINGURE, {expiresIn: '1h'})//عشان موضوع السيكورتي وما يصير في تعديل ع الداتا 
